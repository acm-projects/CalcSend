    ...
    render(){
        ...
        return(
            <div className="buttons">
                ...
                <button name="derivative(" onClick={e => this.props.onClick(e.target.name)}><img src={firstDerivative} className="button-image"/></button>
                <button name="integral(" onClick={e => this.props.onClick(e.target.name)}>integral</button>
                ...
                <button name="sqrt(" onClick={e => this.props.onClick(e.target.name)}><i class="fas fa-square-root-alt"></i></button>
                
                <button name="pi" onClick={e => this.props.onClick(e.target.name)}><img src={pi} className="button-image"/></button>
                <button name="e" onClick={e => this.props.onClick(e.target.name)}>e</button>
                <button name="infinity" onClick={e => this.props.onClick(e.target.name)}>infinity</button>
